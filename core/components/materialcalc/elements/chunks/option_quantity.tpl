<input type="hidden" id="msal_price_original" value="{$_modx->getPlaceholder('materialcalc_price_raw')|default:($_modx->getPlaceholder('price')|replace:' ':'')}" class="msoptionsprice-{$_modx->resource.id}">
